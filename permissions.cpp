...
Permissions::Permissions(short originalPermissions, const char *user)
{
  if (user)
  {
  ...
  permissions = originalPermissions xor umask;
}  // Permissions() standard constructor
